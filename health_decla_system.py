...
class health_check:
    ...
    def symptom_check():
        ...
        question_2 = Label(login_Frame, text = "Have you come into contact with someone experiencing any of the symptoms?",).place(x = 40, y = 160)
    ...
    def vacc_test_status():
        ...
        question_2 = Label(login_Frame, text = "Have you been tested?",).place(x = 40, y = 160)
        #No, Yes-Pending, Yes-Negative, Yes-Positive
        question_3 = Label(login_Frame, text = "Have you been in contact with someone who's a probable/confirmed case?",).place(x = 40, y = 240)
