        ...
        def login_try():
            ...
            if db_exist == True:
                ...
                if username == "" or password == "" or validate == "":
                    messagebox.showerror("Input required", "All fields are required.")
                    return
                print(validate)
                print(password)
    ...
    def validate_database():
        ...
        if account_list:
            ...
            with open('accounts.csv', 'w', newline='') as new_file:
                ...
                writer.writerow(['username',  'password', 'next_destination', 'next_date', 'past_destination', 'past_date', 'exposure_to_symptoms', 'close_contact', 'vacc_status', 'tested_status', 'email', 'password'])
                new_file.close()
            db_exist = True
            return db_exist
